<div class="blogtitle-create">
    <div class="blogtitle-create__head">
        ...
        <p>Set the site title, slogan, and logo that appear in the public header.</p>
    </div>
    ...
    <form action="{{ route('blog.title.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="blogtitle-create__grid">
            <div class="blogtitle-create__field">
                ...
                <input id="blog_title" type="text" name="title" value="{{ old('title') }}" placeholder="Enter website title">
                @error('title')
            ...
            <div class="blogtitle-create__field">
                ...
                <input id="blog_slogan" type="text" name="slogan" value="{{ old('slogan') }}" placeholder="Enter website slogan">
                @error('slogan')
                    <span class="field-error">{{ $message }}</span>
                @enderror
            </div>
            ...
            <div class="blogtitle-create__field blogtitle-create__field--full">
                ...
                <input id="blog_logo" type="file" name="logo" accept=".png,.jpg,.jpeg">
                @error('logo')
                    <span class="field-error">{{ $message }}</span>
                @enderror
            </div>
