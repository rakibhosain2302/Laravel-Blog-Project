...
@prepend('style')
    <style>
        ...
        .post-create-shell::before,
        .post-create-shell::after {
            content: "";
            position: fixed;
            pointer-events: none;
            border-radius: 999px;
            ...
            <div class="post-create-grid">
                <section class="post-hero">
                    <div class="post-hero__top">
                        <div class="post-kicker">Create post</div>
                        <a class="post-back-btn" href="{{ route('posts.index') }}">← Back to Posts</a>
                    </div>
                    <h1>Write something awesome today.</h1>
                    <p>
                        Fill in the details below to publish a new post. Choose a category, add an image, and hit save when you're ready.
                    </p>
                            ...
                            <div class="post-form-grid">
                                <div class="post-form-group">
                                    ...
                                    <input type="text" id="title" name="title" placeholder="Enter Post Title..."
                                        class="post-form-input @error('title') is-invalid @enderror" value="{{ old('title') }}" />
                                    @error('title')
                                ...
                                <div class="post-form-group">
                                    ...
                                    <textarea id="discription" name="discription" class="post-textarea @error('discription') is-invalid @enderror"
                                        placeholder="What's on your mind?">{{ old('discription') }}</textarea>
                                    @error('discription')
                                        <span class="post-error">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="post-form-group">
                                    ...
                                    <input type="text" id="tags" name="tags" placeholder="Enter Tags (comma separated)"
                                        class="post-form-input @error('tags') is-invalid @enderror" value="{{ old('tags') }}" />
                                    @error('tags')
                                        <span class="post-error">{{ $message }}</span>
                                    @enderror
                                </div>
