            ...
            <div class="page-create-grid">
                <section class="page-hero">
                    <div class="page-hero__top">
                        <div class="page-kicker">Create page</div>
                        <a class="page-back-btn" href="{{ route('page.index') }}">← Back to Pages</a>
                    </div>
                    <h1>Create a new navigation page.</h1>
                    <p>
                        Fill in the details below to create a new page. Add a name and description, then save when you're ready.
                    </p>
                ...
                <section class="page-form-card">
                    <div class="page-form-card__head">
                        <div>
                            <h2>Add New Page</h2>
                            <p>Enter your page details and save.</p>
                        </div>
                        <div class="page-pill">New page</div>
                    </div>
                            ...
                            <div class="page-form-grid">
                                <div class="page-form-group">
                                    ...
                                    <input type="text" id="name" name="name" placeholder="Enter Page Name..."
                                        class="page-form-input @error('name') is-invalid @enderror" value="{{ old('name') }}" />
                                    @error('name')
                                ...
                                <div style="display: flex; justify-content: flex-end;">
                                    <button class="page-submit-btn" type="submit">Save Page</button>
                                </div>
                            </div>
                        </form>
                    </div>
